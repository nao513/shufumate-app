...
def render_common_body_inputs(show_labels_prefix=""):
    age = st.number_input(
        f"{show_labels_prefix}年齢",
        min_value=20,
        max_value=100,
        step=1,
        key="common_age"
